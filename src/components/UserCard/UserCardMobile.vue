<template>
    <div class="header">
        ...
        <a-drawer v-model:open="open" class="custom-class ct" root-class-name="root-class-name"
            :root-style="{ color: 'blue' }" :closable="false" placement="right" :getContainer="false">
            <div class="menuIcon">
