...
const routes = [
    ...
    {
        path: '/background', redirect: '/background/article', component: Background, children: [
            { path: 'home', component: BackgroundHome },
            {
                path: 'article', component: BackgroundArticle
            },
            {
                path: 'category', component: BackgroundCategory
            },
            {
                path: 'myinfo', component: BackgroundMyinfo
            },
